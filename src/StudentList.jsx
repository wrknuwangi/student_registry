...
const StudentList = () => {
  ...
  if (status === "loading") return <p className="text-center">Loading students...</p>;
  if (status === "failed") return <p className="text-center text-red-500">Failed to load students</p>;
